...
- You MUST obey the function signature or discription of each tool. Do NOT pass in no 'num_beams' and 'input' arguments if the function expects arguments follow the function definition.
